...
; мигрировано ;;===================================================================================
; мигрировано ;------------------------------------------------------------------------------------------------------------
; мигрировано ;                                    -----Mane KEY-----
; мигрировано ;------------------------------------------------------------------------------------------------------------
; мигрировано ;;===================================================================================
; мигрировано ;	Hotkey, %KEY1%, Off, UseErrorLevel
; мигрировано ;	Hotkey, %KEY1%, rel, On, UseErrorLevel
; мигрировано ;	Hotkey, %KEY3%, Off, UseErrorLevel
; мигрировано ;	Hotkey, %KEY3%, Mira, On, UseErrorLevel
; мигрировано ;	Hotkey, %KEY4%, Off, UseErrorLevel
; мигрировано ;	Hotkey, %KEY4%, Inventory, On, UseErrorLevel
; мигрировано ;	Hotkey, %KEY5%, Off, UseErrorLevel
; мигрировано ;	Hotkey, %KEY5%, qBadge, On, UseErrorLevel
; мигрировано ;	Hotkey, %KEY6%, Off, UseErrorLevel
; мигрировано ;	Hotkey, %KEY6%, Mega1, On, UseErrorLevel
; мигрировано ;	Hotkey, %KEY7%, Off, UseErrorLevel
; мигрировано ;	Hotkey, %KEY7%, Mega2, On, UseErrorLevel
; мигрировано ;	Hotkey, %KEY8%, Off, UseErrorLevel
; мигрировано ;	Hotkey, %KEY8%, Geo, On, UseErrorLevel
; мигрировано ;	Hotkey, %KEY9%, Off, UseErrorLevel
; мигрировано ;	Hotkey, %KEY9%, CODE1, On, UseErrorLevel
; мигрировано ;	Hotkey, %KEY10%, Off, UseErrorLevel
; мигрировано ;	Hotkey, %KEY10%, CODE0, On, UseErrorLevel
; мигрировано ;	Hotkey, %KEY11%, Off, UseErrorLevel
; мигрировано ;	Hotkey, %KEY11%, CODE7, On, UseErrorLevel
; мигрировано ;	Hotkey, %KEY12%, Off, UseErrorLevel
; мигрировано ;	Hotkey, %KEY12%, CODE6, On, UseErrorLevel
; мигрировано ;	Hotkey, %KEY13%, Off, UseErrorLevel
; мигрировано ;	Hotkey, %KEY13%, Cam, On, UseErrorLevel
; мигрировано ;	Hotkey, %KEY14%, Off, UseErrorLevel
; мигрировано ;	Hotkey, %KEY14%, CamAC, On, UseErrorLevel
; мигрировано ;	Hotkey, %KEY15%, Off, UseErrorLevel
; мигрировано ;	Hotkey, %KEY15%, Signl, On, UseErrorLevel
; мигрировано ;	Hotkey, %KEY16%, Off, UseErrorLevel
; мигрировано ;	Hotkey, %KEY16%, steal, On, UseErrorLevel
; мигрировано ;	Hotkey, %KEY17%, Off, UseErrorLevel
; мигрировано ;	Hotkey, %KEY17%, Badgeq, On, UseErrorLevel
; мигрировано ;	Hotkey, %KEY18%, Off, UseErrorLevel
; мигрировано ;	Hotkey, %KEY18%, Arm, On, UseErrorLevel
; мигрировано ;	Hotkey, %KEY19%, Off, UseErrorLevel
; мигрировано ;	Hotkey, %KEY19%, Help, On, UseErrorLevel
; мигрировано ;;===================================================================================
; мигрировано ;------------------------------------------------------------------------------------------------------------
...
; мигрировано ;;===================================================================================
; мигрировано ;------------------------------------------------------------------------------------------------------------
; мигрировано ;                                	-----ManeSaveData-----
; мигрировано ;------------------------------------------------------------------------------------------------------------
; мигрировано ;;===================================================================================
; мигрировано ;	SaveData:
; мигрировано ;		Gui, Submit, NoHide
; мигрировано ;		  	IniWrite, %Radio1Rez%, Settings.ini, Resolution, 1920x1080
; мигрировано ;			IniWrite, %Radio2Rez%, Settings.ini, Resolution, 1680x1050
; мигрировано ;			IniWrite, %Radio3Rez%, Settings.ini, Resolution, 1440x900
; мигрировано ;			IniWrite, %Radio4Rez%, Settings.ini, Resolution, 1280x1024
; мигрировано ;			IniWrite, %Radio5Rez%, Settings.ini, Resolution, 1280x720
; мигрировано ;			IniWrite, %Radio6Rez%, Settings.ini, Resolution, 1920x1920
; мигрировано ;			IniWrite, 1, Settings.ini, Gender, Мужской
; мигрировано ;
; мигрировано ;			IniWrite, %Hot1%, Settings.ini, KeySetup, KEY1
; мигрировано ;			IniWrite, %Hot3%, Settings.ini, KeySetup, KEY3
; мигрировано ;			IniWrite, %Hot4%, Settings.ini, KeySetup, KEY4
; мигрировано ;			IniWrite, %Hot5%, Settings.ini, KeySetup, KEY5
; мигрировано ;			IniWrite, %Hot6%, Settings.ini, KeySetup, KEY6
; мигрировано ;			IniWrite, %Hot7%, Settings.ini, KeySetup, KEY7
; мигрировано ;			IniWrite, %Hot8%, Settings.ini, KeySetup, KEY8
; мигрировано ;			IniWrite, %Hot9%, Settings.ini, KeySetup, KEY9
; мигрировано ;			IniWrite, %Hot10%, Settings.ini, KeySetup, KEY10
; мигрировано ;			IniWrite, %Hot11%, Settings.ini, KeySetup, KEY11
; мигрировано ;			IniWrite, %Hot12%, Settings.ini, KeySetup, KEY12
; мигрировано ;			IniWrite, %Hot13%, Settings.ini, KeySetup, KEY13
; мигрировано ;			IniWrite, %Hot14%, Settings.ini, KeySetup, KEY14
; мигрировано ;			IniWrite, %Hot15%, Settings.ini, KeySetup, KEY15
; мигрировано ;			IniWrite, %Hot16%, Settings.ini, KeySetup, KEY16
; мигрировано ;			IniWrite, %Hot17%, Settings.ini, KeySetup, KEY17
; мигрировано ;			IniWrite, %Hot18%, Settings.ini, KeySetup, KEY18
; мигрировано ;			IniWrite, %Hot19%, Settings.ini, KeySetup, KEY19
; мигрировано ;			MsgBox, 0, SAVE, Данные сохранены.
; мигрировано ;		Reload
; мигрировано ;		return
; мигрировано ;;===================================================================================
; мигрировано ;	SaveData1:
; мигрировано ;		Gui, 3: Submit, NoHide
; мигрировано ;			IniWrite, %vdis%, Settings.ini, Personal, vdis
; мигрировано ;			IniWrite, %qfrac%, Settings.ini, Personal, qfrac
; мигрировано ;			IniWrite, %wTel%, Settings.ini, Personal, wTel
; мигрировано ;			MsgBox, 0, SAVE, Данные сохранены.
; мигрировано ;		Reload
; мигрировано ;		return
; мигрировано ;;===================================================================================
; мигрировано ;	SaveData2:
; мигрировано ;		Gui, 4: Submit, NoHide
; мигрировано ;			IniWrite, %cX%, Settings.ini, cord, cX
; мигрировано ;		Reload
; мигрировано ;		return
; мигрировано ;;===================================================================================
; мигрировано ;	SaveData3:
; мигрировано ;		Gui, 5: Submit, NoHide
; мигрировано ;			IniWrite, %cY%, Settings.ini, cord, cY
; мигрировано ;			IniWrite, %c2Y%, Settings.ini, cord, c2Y
; мигрировано ;		Reload
; мигрировано ;		return
; мигрировано ;;===================================================================================
; мигрировано ;	SaveData4:
; мигрировано ;		Gui, 6: Submit, NoHide
; мигрировано ;			IniWrite, %sTime%, Settings.ini, timestamp, sTime
; мигрировано ;		Reload
; мигрировано ;		return
; мигрировано ;;===================================================================================
; мигрировано ;	SaveData5:
; мигрировано ;		Gui, 7: Submit, NoHide
; мигрировано ;			IniWrite, %mMir1%, Settings.ini, Miranda, mMir1
; мигрировано ;			IniWrite, %mMir2%, Settings.ini, Miranda, mMir2
; мигрировано ;			IniWrite, %mMir3%, Settings.ini, Miranda, mMir3
; мигрировано ;			IniWrite, %mMir4%, Settings.ini, Miranda, mMir4
; мигрировано ;			IniWrite, %mMir5%, Settings.ini, Miranda, mMir5
; мигрировано ;			MsgBox, 0, SAVE, Данные сохранены.
; мигрировано ;		Reload
; мигрировано ;		return
; мигрировано ;;===================================================================================
; мигрировано ;	SaveData6:
; мигрировано ;		Gui, 8: Submit, NoHide
; мигрировано ;			IniWrite, %bSteal1%, Settings.ini, Steal, bSteal1
; мигрировано ;			IniWrite, %bSteal2%, Settings.ini, Steal, bSteal2
; мигрировано ;		Reload
; мигрировано ;		return
; мигрировано ;;===================================================================================
; мигрировано ;	SaveData7:
; мигрировано ;		Gui, 10: Submit, NoHide
; мигрировано ;			IniWrite, %rColor1%, Settings.ini, Color, rColor1
; мигрировано ;			IniWrite, %rColor2%, Settings.ini, Color, rColor2
; мигрировано ;		Reload
; мигрировано ;		return
; мигрировано ;;=================================================================================== 
; мигрировано ;	SaveData8:
; мигрировано ;		Gui, 14: Submit, NoHide
; мигрировано ;			IniWrite, %gbadge%, Settings.ini, Badge, gbadge
; мигрировано ;			MsgBox, 0, SAVE, Данные сохранены.
; мигрировано ;		Reload
; мигрировано ;		return
; мигрировано ;;===================================================================================
...
; мигрировано ;;===================================================================================
; мигрировано ; 			Arm:
; мигрировано ; 		if (Radio1Rez==1)
; мигрировано ; 	{
; мигрировано ; 	sendinput, {i}
; мигрировано ; 		sleep, 90
; мигрировано ; 	MouseMove, 1410, 405
; мигрировано ; 		sleep, 20
; мигрировано ; 	MouseClick, Right
; мигрировано ; 			
; мигрировано ; 		sleep, 20
; мигрировано ; 	MouseMove, 1485, 425
; мигрировано ; 		sleep, 10
; мигрировано ; 	MouseClick, Left
; мигрировано ; 		sleep, 20
; мигрировано ; 	sendinput, {Esc}
; мигрировано ; 	}
; мигрировано ; 		else if (Radio2Rez==1)
; мигрировано ; 	{
; мигрировано ; 	sendinput, {i}
; мигрировано ; 		sleep, 50
; мигрировано ; 	MouseMove, 1275, 405
; мигрировано ; 		sleep, 20
; мигрировано ; 	MouseClick, Right
; мигрировано ; 			
; мигрировано ; 		sleep, 20
; мигрировано ; 	MouseMove, 1360, 430
; мигрировано ; 		sleep, 10
; мигрировано ; 	MouseClick, Left
; мигрировано ; 		sleep, 20
; мигрировано ; 	sendinput, {Esc}
; мигрировано ; 	}
; мигрировано ; 		else if (RadioRez3==1)
; мигрировано ; 	{
; мигрировано ; 	sendinput, {i}
; мигрировано ; 		sleep, 50
; мигрировано ; 	MouseMove, 1095, 345
; мигрировано ; 		sleep, 20
; мигрировано ; 	MouseClick, Right
; мигрировано ; 			
; мигрировано ; 		sleep, 20
; мигрировано ; 	MouseMove, 1170, 370
; мигрировано ; 		sleep, 10
; мигрировано ; 	MouseClick, Left
; мигрировано ; 		sleep, 20
; мигрировано ; 	sendinput, {Esc}
; мигрировано ; 	}
; мигрировано ; 		else if (Radio4Rez==1)
; мигрировано ; 	{
; мигрировано ; 	sendinput, {i}
; мигрировано ; 		sleep, 50
; мигрировано ; 	MouseMove, 1000, 415
; мигрировано ; 		sleep, 20
; мигрировано ; 	MouseClick, Right
; мигрировано ; 			
; мигрировано ; 		sleep, 20
; мигрировано ; 	MouseMove, 1015, 445
; мигрировано ; 		sleep, 10
; мигрировано ; 	MouseClick, Left
; мигрировано ; 		sleep, 20
; мигрировано ; 	sendinput, {Esc}
; мигрировано ; 	}
; мигрировано ; 		else if (Radio5Rez==1)
; мигрировано ; 	{
; мигрировано ; 	sendinput, {i}
; мигрировано ; 		sleep, 50
; мигрировано ; 	MouseMove, 935, 280
; мигрировано ; 		sleep, 20
; мигрировано ; 	MouseClick, Right
; мигрировано ; 			
; мигрировано ; 		sleep, 20
; мигрировано ; 	MouseMove, 1000, 295
; мигрировано ; 		sleep, 10
; мигрировано ; 	MouseClick, Left
; мигрировано ; 		sleep, 20
; мигрировано ; 	sendinput, {Esc}
; мигрировано ; 	}
; мигрировано ; 		else if (Radio6Rez==1)
; мигрировано ; 	{
; мигрировано ; 	sendinput, {i}
; мигрировано ; 		sleep, 50
; мигрировано ; 	MouseMove, 830, 300
; мигрировано ; 		sleep, 20
; мигрировано ; 	MouseClick, Right
; мигрировано ; 			
; мигрировано ; 		sleep, 20
; мигрировано ; 	MouseMove, 885, 320
; мигрировано ; 		sleep, 10
; мигрировано ; 	MouseClick, Left
; мигрировано ; 		sleep, 20
; мигрировано ; 	sendinput, {Esc}
...
; мигрировано ; 		else 
; мигрировано ; 	{ 
; мигрировано ;     MsgBox, 16, Ошибка, К сожалению, твой монитор не подходит под данную функцию, настрой Resolution.
; мигрировано ; 	}
; мигрировано ; 		return
; мигрировано ; ;===================================================================================
; мигрировано ; 			defolt:
; мигрировано ; 	Filedelete, %A_ScriptDir%\Settings.ini
; мигрировано ; 	Reload
; мигрировано ; 		return
; мигрировано ; ;===================================================================================
; мигрировано ; 			relog:
; мигрировано ; 		ButtonПерезапуститьскрипт:
; мигрировано ; 	Reload
; мигрировано ; 	return
; мигрировано ; ;===================================================================================
; мигрировано ; 			exit:
; мигрировано ; 		ButtonЗакрытьскрипт:
; мигрировано ; 		MsgBox, 4, Exit, Вы действительно хотите закрыть скрипт?
; мигрировано ; 	IfMsgBox, Yes
; мигрировано ; 		{
; мигрировано ; 		  ExitApp
; мигрировано ; 		}
; мигрировано ; 	IfMsgBox, No
; мигрировано ; 		{
; мигрировано ; 		  return
; мигрировано ; 		}  
; мигрировано ; 	return
; мигрировано ; ;===================================================================================
; мигрировано ; 			persona:
; мигрировано ; 	Gui, 3: -MaximizeBox
; мигрировано ; 	Gui, 3: Show, w250 h110, Ваша Визитка
; мигрировано ; 	Gui, 3: Color, 838d96
; мигрировано ; 	Gui, 3: Font, c0x000000
; мигрировано ; 	Gui, 3: Add, Edit, x5 y10 w145 h21 vvdis, %vdis%
; мигрировано ; 	Gui, 3: Add, Edit, x5 y60 w145 h21 vqfrac, %qfrac%
; мигрировано ; 	Gui, 3: Add, Edit, x5 y35 w145 h21 vwTel, %wTel%
; мигрировано ; 	Gui, 3: Add, Text, x140 y8 w115 h23 +0x200 +0x1, Discord Name
; мигрировано ; 	Gui, 3: Add, Text, x140 y57 w115 h23 +0x200 +0x1, Ваша фракция
; мигрировано ; 	Gui, 3: Add, Text, x140 y33 w115 h23 +0x200 +0x1, Номер телефона
; мигрировано ; 	Gui, 3: Add, Button, x5 y85 w118 h20 gSaveData1, 𝐀𝐜𝐜𝐞𝐩𝐭
; мигрировано ; 	Gui, 3: Add, Button, x128 y85 w120 h20 gGuiClose1, 𝐃𝐞𝐜𝐥𝐢𝐧𝐞
; мигрировано ; 		return
; мигрировано ; ;===================================================================================
; мигрировано ; 			Mir:
; мигрировано ; 	Gui, 7: -MaximizeBox
; мигрировано ; 	Gui, 7: Show, w510 h165, 𝐌𝐢𝐫𝐚𝐧𝐝𝐚
; мигрировано ; 	Gui, 7: Color, 838d96
; мигрировано ; 	Gui, 7: Font, c0x000000
; мигрировано ; 	Gui, 7: Add, Edit, x5 y5 w500 h20 vmMir1, %mMir1%
; мигрировано ; 	Gui, 7: Add, Edit, x5 y30 w500 h20 vmMir2, %mMir2%
; мигрировано ; 	Gui, 7: Add, Edit, x5 y55 w500 h20 vmMir3, %mMir3%
; мигрировано ; 	Gui, 7: Add, Edit, x5 y80 w500 h20 vmMir4, %mMir4%
; мигрировано ; 	Gui, 7: Add, Edit, x5 y105 w500 h20 vmMir5, %mMir5%
; мигрировано ; 	Gui, 7: Add, Button, x50 y130 w400 h30 gSaveData5, 𝐀𝐜𝐜𝐞𝐩𝐭
; мигрировано ; 		return
; мигрировано ; ;===================================================================================,
; мигрировано ; 			Cust:
; мигрировано ; 	Gui, 14: -MaximizeBox
; мигрировано ; 	Gui, 14: Show, w200 h123, 𝐂𝐮𝐬𝐭
; мигрировано ; 	Gui, 14: Color, 838d96
; мигрировано ; 	Gui, 14: Font, c0x000000
; мигрировано ; 	Gui, 14: Add, Button, x3 y100 w95 h20 gSaveData8, 𝐀𝐜𝐜𝐞𝐩𝐭
; мигрировано ; 	Gui, 14: Add, Button, x102 y100 w95 h20 grelog, 𝐃𝐞𝐜𝐥𝐢𝐧𝐞
; мигрировано ; 		return
; мигрировано ; ;=================================================================================== 
; мигрировано ; 			badge:
; мигрировано ; 	Gui, 14: -MaximizeBox
; мигрировано ; 	Gui, 14: Show, w360 h75, Ваш Жетон
; мигрировано ; 	Gui, 14: Color, 838d96
; мигрировано ; 	Gui, 14: Font, c0x000000
; мигрировано ; 	Gui, 14: Add, Edit, x5 y5 w350 h35 vgbadge, %gbadge%
; мигрировано ; 	Gui, 14: Add, Text, x5 y27 w260 h42 +0x200 +0x1, Пишем полную отыгровку, не ставя "/do".
; мигрировано ; 	Gui, 14: Add, Button, x260 y43 w45 h28 gSaveData8, 𝐀𝐜𝐜𝐞𝐩𝐭
; мигрировано ; 	Gui, 14: Add, Button, x310 y43 w45 h28 gGuiClose12, 𝐃𝐞𝐜𝐥𝐢𝐧𝐞
; мигрировано ; 		return
; мигрировано ; ;=================================================================================== 
; мигрировано ;------------------------------------------------------------------------------------------------------------
; мигрировано ;                                        -----GuiClose-----
; мигрировано ;------------------------------------------------------------------------------------------------------------
; мигрировано ;;===================================================================================
; мигрировано ;			GuiClose1:
; мигрировано ;	Gui 3: Destroy
; мигрировано ;		return
; мигрировано ;;===================================================================================
; мигрировано ;			GuiClose2:
; мигрировано ;	Gui 4: Destroy
; мигрировано ;		return
; мигрировано ;;===================================================================================
; мигрировано ;			GuiClose3:
; мигрировано ;	Gui 5: Destroy
; мигрировано ;		return
; мигрировано ;;===================================================================================
; мигрировано ;			GuiClose4:
; мигрировано ;	Gui 6: Destroy
; мигрировано ;		return
; мигрировано ;;===================================================================================
; мигрировано ;			GuiClose6:
; мигрировано ;	Gui 8: Destroy
; мигрировано ;		return
; мигрировано ;;===================================================================================
; мигрировано ;			GuiClose8:
; мигрировано ;	Gui 10: Destroy
; мигрировано ;		return
; мигрировано ;;===================================================================================
; мигрировано ;			GuiClose11:
; мигрировано ;	Gui 13: Destroy
; мигрировано ;		return
; мигрировано ;;===================================================================================
; мигрировано ;			GuiClose12:
; мигрировано ;	Gui 14: Destroy
; мигрировано ;		return
; мигрировано ;;===================================================================================
; мигрировано ;------------------------------------------------------------------------------------------------------------
; мигрировано ;                                                -----HotKeys-----
...
; мигрировано ;;===================================================================================
; мигрировано ;			steal:
; мигрировано ;		SendMessage, 0x50,, 0x4190419,, A
; мигрировано ;	SendInput, {t}
; мигрировано ;		sleep 200
; мигрировано ;	SendInput,/f Займусь похищением.
; мигрировано ;		sleep 200
; мигрировано ;	SendInput, {enter}
; мигрировано ;		sleep, %sTime%
; мигрировано ;	SendInput, {t}
; мигрировано ;		sleep 200
; мигрировано ;	SendInput,/dep to all: %qfrac% займётся переговорами с захватчиками, ожидайте дальшейших указаний...
; мигрировано ;		sleep 200
; мигрировано ;	SendInput, {enter}
; мигрировано ;		return
; мигрировано ;;===================================================================================
; мигрировано ;			rel:
; мигрировано ;	Buttonrel:
; мигрировано ;		Reload
; мигрировано ;		return
; мигрировано ;;===================================================================================
; мигрировано ;			CODE0:
; мигрировано ;	SendInput, {t}
; мигрировано ;		sleep 200
; мигрировано ;	SendInput,/mark CODE-0 to ALL
; мигрировано ;		sleep 200
; мигрировано ;	SendInput, {enter}
; мигрировано ;		return
; мигрировано ;;===================================================================================
...
; мигрировано ;	SendInput, {t}
; мигрировано ;		sleep 200
; мигрировано ;	SendInput,/mark CODE-1 to ALL
; мигрировано ;		sleep 200
; мигрировано ;	SendInput, {enter}
; мигрировано ;		return
; мигрировано ;;===================================================================================
...
; мигрировано ;	SendInput, {t}
; мигрировано ;		sleep 200
; мигрировано ;	SendInput,/mark CODE-7 to ALL
; мигрировано ;		sleep 200
; мигрировано ;	SendInput, {enter}
; мигрировано ;		return
; мигрировано ;;===================================================================================
...
; мигрировано ;	SendInput, {t}
; мигрировано ;		sleep 200
; мигрировано ;	SendInput,/mark CODE-6 to ALL
; мигрировано ;		sleep 200
; мигрировано ;	SendInput, {enter}
; мигрировано ;		return
; мигрировано ;;===================================================================================
...
; мигрировано ;	SendInput, {t}
; мигрировано ;		sleep 200
; мигрировано ;	SendInput,/mark code 10-20 to %qfrac%
; мигрировано ;		sleep 200
; мигрировано ;	SendInput, {enter}
; мигрировано ;		return
; мигрировано ;;===================================================================================
...
; мигрировано ;	SendInput, {t}
; мигрировано ;		sleep 200
; мигрировано ;	SendInput,/do %gbadge%.
; мигрировано ;		sleep 200
; мигрировано ;	SendInput, {enter}
; мигрировано ;		return
; мигрировано ;;===================================================================================
; мигрировано ;			Badgeq:
; мигрировано ;		if (Radio1Gen==1)
; мигрировано ;	{
; мигрировано ;		SendMessage, 0x50,, 0x4190419,, A
; мигрировано ;	SendInput, {t}
; мигрировано ;		sleep 200
; мигрировано ;	SendInput,/me присмотрелся к человеку напротив
; мигрировано ;		sleep 200
; мигрировано ;	SendInput, {enter}
; мигрировано ;		sleep %sTime%
; мигрировано ;	SendInput, {t}
; мигрировано ;		sleep 200
; мигрировано ;	SendInput,/do Какой символ идентификации можно увидеть на @ и что за информация на нем содержится?{Left 39}
; мигрировано ;	}
; мигрировано ;		else if (Radio2Gen==1)
; мигрировано ;	{
; мигрировано ;		SendMessage, 0x50,, 0x4190419,, A
; мигрировано ;	SendInput, {t}
; мигрировано ;		sleep 200
; мигрировано ;	SendInput,/me присмотрелась к опозновательному знаку человека напротив
; мигрировано ;		sleep 200
; мигрировано ;	SendInput, {enter}
; мигрировано ;		sleep %sTime%
; мигрировано ;	SendInput, {t}
; мигрировано ;		sleep 200
; мигрировано ;	SendInput,/do Какой опознавательный знак на человеке и что на нём написано?
; мигрировано ;		sleep 200
; мигрировано ;	SendInput, {enter}
; мигрировано ;	}
; мигрировано ;		else 
; мигрировано ;	{
; мигрировано ;    MsgBox, 16, Ошибка, К сожалению, ты не оределился с полом, выставь нужный параметр.
; мигрировано ;	}
; мигрировано ;		return
; мигрировано ;;===================================================================================
; мигрировано ;			Inventory:
; мигрировано ;	SendInput, {i}
; мигрировано ;		return
; мигрировано ;;===================================================================================
; мигрировано ;			Signl:
...
; мигрировано ;	SendInput, {t}
; мигрировано ;		sleep 200
; мигрировано ;	SendInput,/dep to all: Сработала ли сигнализация в каком либо частном/муниципальном заведении?
; мигрировано ;		sleep 200
; мигрировано ;	SendInput, {enter}
; мигрировано ;		return
;===================================================================================
...
;мигрировано;		if (Radio1Rez==1)
;мигрировано;	{
;мигрировано;    State2:=!State2
;мигрировано;    If state2
;мигрировано;    {
;мигрировано;    CustomColor2 = 	EEAA99
;мигрировано;    Gui 3: +LastFound +AlwaysOnTop -Caption +ToolWindow
;мигрировано;    Gui 3: Color, black
;мигрировано;    Gui 3: Font, s9
;мигрировано;    Gui 3: Font, w3000
;мигрировано;    Gui 3: Font, cFFFFFF
;мигрировано;		Gui, 3: Add, Picture, x0 y0 w1920 h1080, %A_ScriptDir%\img\memo.png			
;мигрировано;    WinSet, TransColor, %CustomColor2% 200
;мигрировано;    Gui 3: Show, x%cX% y%cY% NoActivate, window.
;мигрировано;    }  
;мигрировано;    else
;мигрировано;    Gui 3: Destroy
;мигрировано;	}
...
;мигрировано;    Gui 3: Font, w3000
;мигрировано;    Gui 3: Font, cFFFFFF
;мигрировано;		Gui, 3: Add, Picture, x0 y0 w1680 h1050, %A_ScriptDir%\img\memo.png			
;мигрировано;    WinSet, TransColor, %CustomColor2% 200
;мигрировано;    Gui 3: Show, x%cX% y%cY% NoActivate, window.
;мигрировано;    }  
;мигрировано;    else
;мигрировано;    Gui 3: Destroy
;мигрировано;	}
;мигрировано;		else if (Radio3Rez==1)
;мигрировано;	{
;мигрировано;    State2:=!State2
;мигрировано;    If state2
;мигрировано;    {
...
;мигрировано;    Gui 3: Font, w3000
;мигрировано;    Gui 3: Font, cFFFFFF
;мигрировано;		Gui, 3: Add, Picture, x0 y0 w1440 h900, %A_ScriptDir%\img\memo.png			
;мигрировано;    WinSet, TransColor, %CustomColor2% 200
;мигрировано;    Gui 3: Show, x%cX% y%cY% NoActivate, window.
;мигрировано;    }  
;мигрировано;    else
...
;мигрировано;    Gui 3: Font, w3000
;мигрировано;    Gui 3: Font, cFFFFFF
;мигрировано;		Gui, 3: Add, Picture, x0 y0 w1280 h1080, %A_ScriptDir%\img\memo.png			
;мигрировано;    WinSet, TransColor, %CustomColor2% 200
;мигрировано;    Gui 3: Show, x%cX% y%cY% NoActivate, window.
;мигрировано;    }  
;мигрировано;    else
...
;мигрировано;    Gui 3: Font, w3000
;мигрировано;    Gui 3: Font, cFFFFFF
;мигрировано;		Gui, 3: Add, Picture, x0 y0 w1280 h720, %A_ScriptDir%\img\memo.png			
;мигрировано;    WinSet, TransColor, %CustomColor2% 200
;мигрировано;    Gui 3: Show, x%cX% y%cY% NoActivate, window.
;мигрировано;    }  
;мигрировано;    else
...
;мигрировано;    Gui 3: Font, w3000
;мигрировано;    Gui 3: Font, cFFFFFF
;мигрировано;		Gui, 3: Add, Picture, x0 y0 w1920 h1920, %A_ScriptDir%\img\memo.png			
;мигрировано;    WinSet, TransColor, %CustomColor2% 200
;мигрировано;    Gui 3: Show, x%cX% y%cY% NoActivate, window.
;мигрировано;    }  
;мигрировано;    else
...
;мигрировано;;===================================================================================
;мигрировано;			Mira:
;мигрировано;	State3:=!State3
;мигрировано;	If state3
;мигрировано;	{
;мигрировано;	CustomColor3 = EEAA99
;мигрировано;	Gui +LastFound +AlwaysOnTop -Caption +ToolWindow 
;мигрировано;	Gui, Color, black
;мигрировано;	Gui, Font, s8
;мигрировано;	Gui, Font, cYellow
;мигрировано;	Gui, Font, w650
;мигрировано;	Gui, Font,, verdana
;мигрировано;	GUI, ADD,TEXT,cBlue,==============================================================================================
;мигрировано;			GUI, ADD,TEXT,cRed,`                        		 Правило введёное Верховным судом USA:
;мигрировано;			GUI, ADD,TEXT,c%rColor2%, %mMir1%
;мигрировано;			GUI, ADD,TEXT,c%rColor2%, %mMir2%
;мигрировано;			GUI, ADD,TEXT,c%rColor2%, %mMir3%
;мигрировано;			GUI, ADD,TEXT,c%rColor2%, %mMir4%
;мигрировано;			GUI, ADD,TEXT,c%rColor2%, %mMir5%
;мигрировано;	GUI, ADD,TEXT,cBlue,==============================================================================================
;мигрировано;	WinSet, TransColor, %CustomColor3% 180
;мигрировано;	Gui, Show, x0 y0 NoActivate, window. 
;мигрировано;	}
;мигрировано;	Else
;мигрировано;	Gui Destroy
;мигрировано;		return
;мигрировано;;===================================================================================
;мигрировано;			Help:
;мигрировано;	State3:=!State3
...
;мигрировано;	Gui, Color, black
;мигрировано;	Gui, Font, s8
;мигрировано;	Gui, Font, c0x000000
;мигрировано;	Gui, Font, w680
;мигрировано;	Gui, Font,, verdana
;мигрировано;			GUI, ADD,TEXT,c%rColor2%, .угон .нарко .фрапс .вин .тикет Розыск-.кпк
;мигрировано;			GUI, ADD,TEXT,c%rColor2%, Проверка личности: .бдкпк | .отпечатки | .кровь (в лаборатории) 
;мигрировано;			GUI, ADD,TEXT,c%rColor2%, .адвокат .прокурор .взятка .обыск .юр .кпз 
;мигрировано;			GUI, ADD,TEXT,c%rColor2%, .пут .пул .спавн .лиц .волна .госнабор
;мигрировано;			GUI, ADD,TEXT,c%rColor2%, .радио .визитка .кам .скам1/2 
;мигрировано;			GUI, ADD,TEXT,cRed, Закон о гос.службе | Требовать удостоверение - ст. 14.2 
;мигрировано;			GUI, ADD,TEXT,cRed, ПК | Опознание личности - ст. 15 | Отойти на 10 метров - ст. 20 пункт 2
;мигрировано;			GUI, ADD,TEXT,cRed, ПК | Обыск при проходе на закрытую территорию(холл) - ст. 23 пункт 2.1 
;мигрировано;			GUI, ADD,TEXT,c%rColor2%, АК | Ложный вызов - ст. 6.3(5000$) Оск - ст. 7.1(5000$)
;мигрировано;			GUI, ADD,TEXT,c%rColor2%, АК | Мелкое хулиг. - ст. 9.1(10000$) Стрельба - ст. 10(5000$)
;мигрировано;			GUI, ADD,TEXT,c%rColor2%, АК | Хулиганство(Оск. гос. сотрудника) - ст. 9.2(20000$)
;мигрировано;			GUI, ADD,TEXT,cGreen, ДК | Остановка Авто - ст. 7(3000$) Выйти из машины - ст. 17 и 71
;мигрировано;			GUI, ADD,TEXT,cGreen, ДК | Предъяв.лицензию - ст.6(3000$) Основания для траф.стопа - ст. 70
;мигрировано;			GUI, ADD,TEXT,cGreen, ДК | Нет номера/грязный номер - ст. 66(15000$ и эвак.авто)
;мигрировано;			GUI, ADD,TEXT,cGreen, Текст при остановке авто - Я имею право остановить вас на основании
;мигрировано;			GUI, ADD,TEXT,cGreen, 70 статьи дк, также требую выйти из машины на основании 17 и 71 статьи дк
;мигрировано;			GUI, ADD,TEXT,cGreen, и показать лицензии на основании 6 статьи дк. Это законные требования.
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, Выход под залог запрещен: 6.3,6.4,12.1,12.2,12.3,12.12,12.14,13.6, 
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, 13.8, 14.1,14.2,16.2,16.17,17.1 ук. | Более чем по 3-ем статьям.
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, Судимость выдается за 5 звезд. 
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, НАНЕСЕНИЕ ТЕЛ.ПОВРЕЖДЕНИЙ/УБИЙСТВО - 6.1/(CR)6.2  4/5 звезд
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, УГОН АВТО - 10.7  3 звезды
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, УМЫШЛЕННОЕ ПОВРЕЖДЕНИЕ ЧУЖОГО ИМУЩ. - 10.8  3 звезды
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, УМЫШЛЕННОЕ ПОВРЕЖДЕНИЕ ГОС.ИМУЩ. - 10.8.1  3 звезды	
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, ЗАКРЫТЫЙ ОБЪЕКТ - 12.7  3 звезды
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, НОШЕНИЕ ОРУЖИЯ - 12.8  4 звезды 
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, НАРКОТА - 13.1/13.2/(CR)13.3 (3,7,20 грамм) - 2/4/5 звезды
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, 1 пак. - 1 грамм | до 3-х грамм(вкл.) - легально и изымается без статьи.
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, ДАЧА ВЗЯТКИ - 15.5  3 звезды
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, ПРОВОКАЦИЯ - 15.8  2 звезды
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, ЧЕЛОВЕК НАХОДИТСЯ В РОЗЫСКЕ - 16.16  1 звезда
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, (CR)ПОСЯГАТЕЛЬСТВО НА ЖИЗНЬ СОТРУДНИКА - 17.1  5 звезд
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, ТЕЛ.ПОВРЕЖДЕНИЯ СОТРУДНИКУ - 17.2  3 звезды
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, НЕПОДЧИНЕНИЕ ТРЕБОВАНИЯМ - 17.5  3 звезды 
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, ОТКАЗ ОТ ОПЛАТЫ ШТРАФА - 17.6  3 звезды
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, УКРЫВАТЕЛЬСТВО - 17.7  2 звезды
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, ПОМЕХА ПРИ ЗАДЕРЖАНИИ - 17.8  2 звезды
;мигрировано;			GUI, ADD,TEXT,c%rColor1%, ПОБЕГ ПРИ ЗАДЕРЖАНИИ - 17.10  4 звезды
;мигрировано;     	WinSet, TransColor, %CustomColor3% 200
;мигрировано;	Gui, Show, x1385 y56 NoActivate, window. 
;мигрировано;	}
;мигрировано;	Else
;мигрировано;	Gui Destroy
;мигрировано;		return
